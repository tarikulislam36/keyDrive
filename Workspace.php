...
<!-- Left Sidebar -->
<!-- 
<div class=" h-96 w-9 mx-4 px-8 bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 ">
...
<div class="container flex h-screen justify-center">
